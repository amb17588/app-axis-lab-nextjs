...
export const metadata: Metadata = {
  title: 'ISmart Translator — Privacy Policy & EULA | App Axis Lab',
}

export default function ISmartTranslatorPrivacy() {
  return (
    <PrivacyLayout
    ...
    >
      <div className={s.card}>
        <div className={s.privacyContent}>
          ...
          <p>We do not require account creation. If you contact us:</p>
          <ul>
            <li>Email address</li>
            <li>Any information you provide</li>
          </ul>
          <p><strong>b. Audio &amp; Text Data</strong></p>
          <p>To provide translation:</p>
          <ul>
            <li>Voice input (microphone)</li>
            <li>Text entered by the user</li>
          </ul>
          <p>Note: data is processed in real-time and we do not store this data permanently.</p>
          ...
          <p>This helps show personalized ads. Ads may be tailored based on user interests. Users in certain regions (EEA, UK, etc.) may be asked for consent.</p>
          <p>Users can opt out of personalized advertising by adjusting device ad settings or visiting: <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer">https://adssettings.google.com</a></p>
          ...
          <p>We may use translation APIs, analytics tools, and advertising networks (AdMob). These services operate under their own privacy policies. We recommend reviewing the privacy policies of our partners:</p>
          <ul>
          ...
          <p>We implement HTTPS encryption, minimal data collection, and no unnecessary storage.</p>

          <h2>7. Data Retention</h2>
          <ul>
            <li>Translation data is not stored</li>
            <li>Emails may be retained for support</li>
          </ul>

          <h2>8. AI Translation Disclaimer</h2>
          ...
          <ul>
            ...
            <li>Use the App to transmit harmful, abusive, defamatory, or infringing content</li>
          ...
          <p>The App, including all content, features, design, trademarks, and software, is owned by App Axis Lab or its licensors and is protected by copyright, trademark, and other intellectual property laws. This Agreement does not transfer any ownership rights to you.</p>

          <h2>4. User Content &amp; Conduct</h2>
          <p>You may provide voice input, text, and other content through the App ("User Content") to obtain translation services. You retain ownership of your User Content. You are solely responsible for User Content you submit and for ensuring you have the right to use it. You agree not to submit content that is illegal, harmful, infringing, or violates third-party rights.</p>
          <p>Translation results are provided for informational purposes only. We do not guarantee accuracy, completeness, or suitability of translations for any purpose, including legal, medical, or professional use.</p>

          <h2>5. AI Translation Disclaimer</h2>
          <p>Translation results may be generated using automated systems, artificial intelligence, or third-party translation services. Translation accuracy is not guaranteed and users should independently verify important information.</p>
          ...
          <p>THE APP IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS, IMPLIED, OR STATUTORY, INCLUDING IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE APP WILL BE UNINTERRUPTED, ERROR-FREE, SECURE, OR FREE OF HARMFUL COMPONENTS.</p>
